...
public class HsqldbUserDaoTest extends TestCase {
	...
	private static final String LAST_NAME_UPDATE2 = "Hoking";
	private static final String FIRST_NAME_UPDATE2 = "Stiven";
	private static final String FIRST_NAME2 = "Elon";
	private static final String LAST_NAME2 = "Mask";
	private static final long ID = 1000L;

	private static final String LAST_NAME_UPDATE = "Chebanenko";
	private static final String FIRST_NAME_UPDATE = "Serhii";
	...
	protected IDatabaseConnection getConnection() throws Exception {
		connectionFactory = new ConnectionFactoryImpl("org.hsqldb.jdbcDriver"
				,"jdbc:hsqldb:file:db/usermanagement171"
				,"sa"
				,"");
